...
@CrossOrigin(maxAge = 3600, origins = {"https://bluejund.com:443", "https://www.bluejund.com:443", "http://localhost:8081", "http://localhost:8080", "http://localhost:4200/"}, allowedHeaders = "Requestor-Type", exposedHeaders = "X-Get-Header")
@RestController
@RequestMapping("/api")
